...
/datum/equipment_preset/other/freelancer/standard/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/shoes/marine/merc/knife/upp, WEAR_FEET)
...
/datum/equipment_preset/other/xeno_cultist/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/shoes/marine/merc/knife/upp(new_human), WEAR_FEET)
